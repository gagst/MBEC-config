# Taken from https:#github.com/aziele/unique-namer/blob/main/src/namer/data/animals.py
ANIMALS = [
    "aardvark",
    "aardwolf",
    "adder",
...
# Taken from: https://github.com/moby/moby/blob/39f7b2b6d0156811d9683c6cb0743118ae516a11/pkg/namesgenerator/names-generator.go#L852-L863
SCIENTISTS = [
    ...
    # In 2006, she became the first female recipient of the ACM's Turing Award. https:#en.wikipedia.org/wiki/Frances_E._Allen
    "allen",
    ...
    "bose",
    # Katherine Louise Bouman is an imaging scientist and Assistant Professor of Computer Science at the California Institute of Technology.
    # She researches computational methods for imaging, and developed an algorithm that made possible the picture first visualization of a black hole using the Event Horizon Telescope.
    ...
    "carson",
    # Dame Mary Lucy Cartwright - British mathematician who was one of the first to study what is now known as chaos theory.
    # Also known for Cartwright's theorem which finds applications in signal processing. https:#en.wikipedia.org/wiki/Mary_Cartwright
    "cartwright",
    ...
    # With Robert Elliot Kahn, he designed TCP and IP, the primary data communication protocols of the Internet and other computer networks.
    ...
    "chandrasekhar",
    # Sergey Alexeyevich Chaplygin (Russian: Серге́й Алексе́евич Чаплы́гин; April 5, 1869 – October 8, 1942) was a Russian and Soviet physicist, mathematician, and mechanical engineer.
    # He is known for mathematical formulas such as Chaplygin's equation and for a hypothetical substance in cosmology called Chaplygin gas, named after him.
    ...
    "yalow",
    # da Yonath - an Israeli crystallographer, the first woman from the Middle East to win a Nobel prize in the sciences. https:#en.wikipedia.org/wiki/Ada_Yonath
    "yonath",
    # Nikolay Yegorovich Zhukovsky (Russian: Никола́й Его́рович Жуко́вский, January 17 1847 – March 17, 1921) was a Russian scientist, mathematician and engineer, and a founding father of modern aero- and hydrodynamics. Whereas contemporary scientists scoffed at the idea of human flight, Zhukovsky was the first to undertake the study of airflow. He is often called the Father of Russian Aviation. https:#en.wikipedia.org/wiki/Nikolay_Yegorovich_Zhukovsky
    "zhukovsky",
]

# Taken from https://github.com/aziele/unique-namer/blob/main/src/namer/data/plants.py
PLANTS = [
    "acacia",
    "acorn",
    "agave",
